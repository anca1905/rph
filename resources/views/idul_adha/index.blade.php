                ...
                <form action="{{ route('idul_adha.import') }}" method="POST" enctype="multipart/form-data" class="flex flex-col">
                    ...
                    <div class="px-6 py-5 bg-slate-50/50">
                        <div class="mb-4">
                            ...
                            <p class="text-xs text-slate-500 mt-2">Sistem secara otomatis mendukung import dari file Excel format Laporan Pemotongan Hewan Kurban (8 kolom: No, Tanggal, Lokasi/Desa, Alamat, Kec/Desa, Jenis Hewan, Jumlah, Pelapor) maupun format template 13 kolom.</p>
                        </div>
                    </div>
